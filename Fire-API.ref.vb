...
Public Class Fire_API_ref
    ...
    Public Sub New(ApplicationName As String)
        ...
        If IO.Directory.Exists(Constants.API_Folder.Substring(0, Constants.API_Folder.Length - 9)) Then
            IO.Directory.CreateDirectory(Constants.API_Folder.Substring(0, Constants.API_Folder.Length - 9))
        End If
        If IO.Directory.Exists(Constants.API_Folder) = False Then
            IO.Directory.CreateDirectory(Constants.API_Folder)
        End If
