...
Public Class PrintableRichTextBox
    Inherits RichTextBox
    ' Convert the unit that is used by the .NET framework (1/100 inch) and the
    ' unit that is used by Win32 API calls (twips 1/1440 inch)
    ...
    ' Map SendMessage function to SendMessageA function in Win32 API
